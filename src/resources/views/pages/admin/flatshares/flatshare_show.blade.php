        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <div class="flex items-center space-x-2 text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">
                    <a href="{{ route('admin.home') }}" class="hover:text-black transition">Dashboard</a>
                    <span>/</span>
            ...
            <div
                class="bg-black p-6 rounded-[2.5rem] text-white flex items-center space-x-6 shadow-2xl relative overflow-hidden group">
                <div
                ...
                <button onclick="copyToken('{{ $flatshare->invite_token }}')"
                    class="h-10 w-10 bg-zinc-800 rounded-xl flex items-center justify-center hover:bg-[#D9FF40] hover:text-black transition-all active:scale-90">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-[3.5rem] p-10 border border-gray-100 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        @forelse($flatshare->users as $member)
                            <div
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-black text-gray-900 tracking-tight uppercase text-sm">
                                            {{ $member->full_name }}</h4>
                        ...
                        @empty
                            <p class="text-center text-gray-400 text-sm italic py-10">No residents found in this ecosystem.
                            </p>
                        @endforelse
                    </div>
                </div>
            ...
            <div class="space-y-6">
                <div class="bg-zinc-950 p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <form action="{{ route('user.flatshare.invite', $flatshare->id) }}" method="POST" class="space-y-4">
                            @csrf
                            <div class="relative">
