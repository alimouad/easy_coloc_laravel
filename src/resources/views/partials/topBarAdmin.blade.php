   <nav class="bg-white border-b border-black/5 px-12 h-24 flex items-center justify-between sticky top-0 z-50">
        <div class="flex items-center space-x-12">
            ...
            <div class="hidden md:flex items-center space-x-8 border-l border-gray-100 pl-12">
                <a href="#" class="text-[10px] font-black uppercase tracking-[0.2em] text-black">Overview</a>
                <a href="#" class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 hover:text-black transition-colors">Nodes</a>
                <a href="#" class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 hover:text-black transition-colors">Infrastructure</a>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-6">
            ...
            <form action="{{ route('auth.logout') }}" method="POST">
                @csrf
                <button class="w-10 h-10 border border-black/10 rounded-xl flex items-center justify-center hover:bg-black hover:text-[#D9FF40] transition-all">
