        ...
        <div class="relative">
            ...
            <div
                ...
                <div class="flex items-center space-x-3 mb-4">
                    <div
                        class="w-12 h-12 rounded-xl bg-black flex items-center justify-center text-[#D9FF40] font-black">
                        M
                    </div>
                    <div>
                ...
                <div
                    class="inline-block lime-accent text-black text-[10px] font-black px-2 py-1 rounded-lg uppercase tracking-tighter">
                    ⭐ 4.98 Reputation
                </div>
            </div>
            ...
            <div class="absolute bottom-10 -right-10 bg-black p-8 rounded-[2.5rem] shadow-2xl w-[280px] text-white">
                <div class="flex justify-between items-start mb-8">
                    <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500">Balance ID
                        #772-90</span>
